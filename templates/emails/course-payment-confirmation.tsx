...
export default function CoursePaymentConfirmationEmail({
	firstName,
	courseTitle,
	priceLabel,
}: {
			...
			<div style={card}>
				...
				>
					...
					<p style={{ margin: "10px 0 0" }}>
						We received your payment for <strong>{courseTitle}</strong>.
					</p>
					<p style={{ margin: "10px 0 0" }}>
						Amount: <strong>{priceLabel}</strong>
					</p>
					<p style={{ margin: "10px 0 0" }}>
						Your course enrollment is active. You can access the classes in
						your dashboard.
					</p>
				</div>
